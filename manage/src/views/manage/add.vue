...
import { getGoodAdd, getGoodInfo, getGoodEdit } from "../../util/axios";
export default {
  data() {
    return {
  ...
  methods: {
    ...
    ...mapActions({
      ...
      //商品列表
      getGoodsList: "manage/getGoodListAction",
      getGoodsCount: "manage/getCountAction"
    }),
    //添加事件
    add() {
